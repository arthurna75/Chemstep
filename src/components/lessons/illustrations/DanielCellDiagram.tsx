export default function DanielCellDiagram() {
  return (
    ...
    >
      ...
      <text x="73" y="54" textAnchor="middle" fontSize="13" fontWeight="bold" fill="#475569">Zn</text>
      {/* 산화 반응식 */}
      ...
      <text x="110" y="228" textAnchor="middle" fontSize="12" fill="#1D4ED8">ZnSO₄(aq)</text>
      {/* 비커 레이블 */}
      ...
      <text x="403" y="54" textAnchor="middle" fontSize="13" fontWeight="bold" fill="#92400E">Cu</text>
      {/* 환원 반응식 */}
      ...
      <text x="370" y="228" textAnchor="middle" fontSize="12" fill="#B45309">CuSO₄(aq)</text>
      ...
      {/* ── 외부 도선 + 전류계 ── */}
      {/* 도선 (위쪽) */}
      <polyline points="93,60 93,46 240,46 387,46 387,60"
        fill="none" stroke="#475569" strokeWidth="2.5" />
      {/* 전류계 원 */}
      <circle cx="240" cy="46" r="13" fill="white" stroke="#475569" strokeWidth="2" />
      <text x="240" y="50" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#334155">A</text>

      {/* 전자 흐름 화살표 (도선 위) */}
      <text x="160" y="38" textAnchor="middle" fontSize="11" fill="#6366F1">e⁻ →</text>
      <text x="320" y="38" textAnchor="middle" fontSize="11" fill="#6366F1">e⁻ →</text>
