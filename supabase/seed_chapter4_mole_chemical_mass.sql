...
BEGIN
  ...
  VALUES (
    ...
    '다른 원소의 원자 질량을 이 기준과 비교한 상대적인 값을 원자량이라 한다.\n'
    '- 원자량은 단위가 없는 상대적인 값이다.\n'
    '- 주요 원소 원자량(반올림): H=1, C=12, N=14, O=16, Na=23, Cl=35.5, Ca=40\n\n'
    '■ 분자량이란?\n'
    '분자를 구성하는 모든 원자들의 원자량을 합한 값이다.\n'
    '분자량도 원자량과 마찬가지로 단위가 없는 상대적인 값이다.\n\n'
    '■ 화학식량이란?\n'
    '이온 결합 화합물처럼 분자가 아닌 물질의 경우, 실험식(화학식)에 포함된\n'
    '원자들의 원자량의 합을 화학식량이라 한다.\n'
  ...
  VALUES (
    ...
    '몰 질량과 물질의 양',
    E'■ 몰 질량(M)이란?\n'
    '어떤 물질 1몰의 질량을 몰 질량이라 하며, 단위는 g/mol이다.\n'
  ...
  VALUES (
    ...
    '화학식량과 조성 백분율',
    E'■ 조성 백분율(질량 백분율)이란?\n'
    '화합물에서 각 원소의 질량이 전체 질량에서 차지하는 비율을 백분율(%)로 나타낸 것\n'
    '- 같은 화합물이라면 양에 관계없이 조성 백분율은 항상 일정 (일정 성분비 법칙)\n\n'
    '■ 조성 백분율 계산\n'
    '원소 X의 질량 백분율 = (원소 X의 원자량 × 원자 수) / 분자량 × 100 (%)\n\n'
    '예시: H₂O에서 각 원소의 질량 백분율 (H=1, O=16, 분자량=18)\n'
    '- H의 질량 백분율: (1×2) / 18 × 100 = 11.1%\n'
    '- O의 질량 백분율: 16 / 18 × 100 = 88.9%\n\n'
    '■ 실험식(경험식)과 분자식\n'
    '- 실험식(경험식): 화합물을 구성하는 원소들의 원자 수 비를 가장 간단한 정수비로 나타낸 식\n'
    '  예: 포도당(C₆H₁₂O₆) → 실험식 CH₂O\n'
    '- 분자식: 분자를 이루는 원자들의 실제 개수를 나타낸 식\n'
    '  분자식 = (실험식)ₙ  (n은 정수)\n\n'
    '■ 실험식에서 분자식 결정\n'
    '① 조성 백분율로 원소 비율 파악\n'
    '② 원자 수 비로 실험식 결정\n'
