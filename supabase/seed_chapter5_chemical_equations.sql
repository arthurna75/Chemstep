...
BEGIN
  ...
  VALUES (
    ...
    '■ 상태 기호\n'
    '물질의 상태를 괄호 안에 표시한다:\n'
    '- (s): 고체(solid)  - (l): 액체(liquid)  - (g): 기체(gas)  - (aq): 수용액(aqueous)\n\n'
    '■ 화학 반응식 읽기\n'
    '2H₂(g) + O₂(g) → 2H₂O(l)\n'
  ...
  VALUES (
    ...
    '두 반응물이 정확한 계수비(몰비)로 존재하지 않을 경우, 먼저 소모되는 반응물이 반응을 제한한다.\n'
  ...
  VALUES (
    ...
    '■ 합성(결합) 반응 (Synthesis)\n'
    '두 가지 이상의 물질이 결합하여 하나의 새로운 물질을 만드는 반응: A + B → AB\n'
    '- 2Na + Cl₂ → 2NaCl   (염화 나트륨 생성)\n'
    '- 2Mg + O₂ → 2MgO   (마그네슘 산화)\n\n'
    '■ 분해 반응 (Decomposition)\n'
    '하나의 물질이 두 가지 이상의 물질로 나뉘는 반응: AB → A + B\n'
    '- 2H₂O₂ → 2H₂O + O₂   (과산화수소 분해)\n'
    '- 2H₂O → 2H₂ + O₂   (물의 전기 분해)\n\n'
    '■ 치환(단일 치환) 반응 (Single Displacement)\n'
    '한 원소가 화합물에서 다른 원소를 밀어내는 반응: A + BC → AC + B\n'
    '- Zn + 2HCl → ZnCl₂ + H₂↑   (아연과 염산의 반응)\n'
    '- Fe + CuSO₄ → FeSO₄ + Cu   (반응성 비교 활용)\n\n'
    '■ 이중 치환(복분해) 반응 (Double Displacement)\n'
    '두 화합물의 양이온이 서로 교환되는 반응: AB + CD → AD + CB\n'
    '- NaCl + AgNO₃ → AgCl↓ + NaNO₃   (앙금 생성)\n'
    '- HCl + NaOH → NaCl + H₂O   (중화 반응)\n\n'
    '■ 연소 반응 (Combustion)\n'
    '물질이 산소와 빠르게 반응하여 열과 빛을 방출하는 반응\n'
    '- CH₄ + 2O₂ → CO₂ + 2H₂O   (메탄 연소)\n'
    '- C₃H₈ + 5O₂ → 3CO₂ + 4H₂O   (프로판 연소)\n\n'
    '■ 앙금 생성 반응\n'
    '수용액에서 난용성 염(앙금)이 생성되는 이중 치환 반응 (↓ 기호로 표시)\n'
    '- Ba²⁺ + SO₄²⁻ → BaSO₄↓ (흰색)   Ag⁺ + Cl⁻ → AgCl↓ (흰색)',
    '[
  ...
  VALUES (
    ...
    '반응 후 에너지가 방출되는 반응. 생성물의 에너지 < 반응물의 에너지\n'
    '- 주변의 온도가 올라간다 (열 방출)\n'
    '- 반응열 ΔH < 0\n'
    '- 예: 연소 반응, 철의 산화(녹 생성), 중화 반응, 손난로(철 분말 산화)\n'
    '- CH₄ + 2O₂ → CO₂ + 2H₂O + 에너지(열)\n\n'
    '■ 흡열 반응 (Endothermic Reaction)\n'
    '반응이 진행되려면 에너지를 흡수해야 하는 반응. 생성물의 에너지 > 반응물의 에너지\n'
    '- 주변의 온도가 내려간다 (열 흡수)\n'
    '- 반응열 ΔH > 0\n'
    '- 예: 광합성, 물의 전기 분해, 질산 암모늄 용해(냉찜질팩)\n'
