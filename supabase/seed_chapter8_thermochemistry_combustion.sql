...
BEGIN
  ...
  VALUES (
    ...
    '예:\n'
    '- H–H 결합 에너지: 436 kJ/mol\n'
    '- O=O 결합 에너지: 498 kJ/mol\n'
    '- O–H 결합 에너지: 463 kJ/mol\n'
    '- C–H 결합 에너지: 414 kJ/mol\n'
  ...
  VALUES (
    ...
    '주요 연료의 완전 연소식:\n'
    '- 메탄(천연가스): CH₄ + 2O₂ → CO₂ + 2H₂O  ΔH° = −890 kJ/mol\n'
    '- 에탄: C₂H₆ + 7/2 O₂ → 2CO₂ + 3H₂O  ΔH° = −1560 kJ/mol\n'
    '- 프로판(LPG): C₃H₈ + 5O₂ → 3CO₂ + 4H₂O  ΔH° = −2220 kJ/mol\n'
    '- 옥탄(가솔린): C₈H₁₈ + 12.5O₂ → 8CO₂ + 9H₂O  ΔH° = −5471 kJ/mol\n\n'
    '■ 불완전 연소 (Incomplete Combustion)\n'
    '산소가 부족할 때 CO(일산화탄소)와 그을음(탄소 입자)이 생성.\n'
    'CH₄ + 3/2 O₂ → CO + 2H₂O  (산소 부족, CO 생성)\n'
    'CH₄ + O₂ → C(s) + 2H₂O  (산소 극도 부족, 그을음)\n\n'
    '■ 연료 발열량 비교 (MJ/kg)\n'
    '수소(H₂): 142 MJ/kg > 천연가스(CH₄): 55 MJ/kg\n'
    '> LPG(C₃H₈): 50 MJ/kg > 가솔린: 44 MJ/kg > 석탄: 24 MJ/kg\n\n'
    '■ 양적 계산 흐름\n'
    '① 연료 질량 → 몰수 (÷ 몰질량)\n'
  ...
  VALUES (
    ...
    '- CH₄: ΔH°c = −890 kJ/mol\n'
    '- C₃H₈: ΔH°c = −2220 kJ/mol\n'
    '- C₈H₁₈(옥탄): ΔH°c = −5471 kJ/mol\n'
    '- H₂: ΔH°c = −286 kJ/mol\n\n'
  ...
  VALUES (
    ...
    '  메탄: 약 595°C / 가솔린: 약 246°C / 수소: 약 500°C\n'
    '- 연소 범위(Flammability Limit): 공기 중 가연성 가스 농도 범위\n'
    '  메탄: 5~15 vol% / 수소: 4~75 vol% (수소가 범위 넓어 더 위험)\n\n'
    '■ 연소 제어 — 연쇄 반응\n'
    ...
    '- 냉각 소화: 물 뿌려 온도↓ → k↓ → 연소 중단 (점화원 제거)\n'
    '- 질식 소화: CO₂·모래로 O₂ 차단 (산소 제거)\n'
    '- 제거 소화: 연료 차단, 가스 밸브 잠금 (연료 제거)\n'
    '- 억제 소화: 할론·분말 소화제로 라디칼 포획 (연쇄 반응 차단)\n\n'
    '■ 촉매와 연소 제어\n'
