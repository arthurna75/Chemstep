...
■ 주요 원소의 전자 배치 (H ~ Ar)
  H  (Z=1):  K(1)                원자가 전자: 1
  He (Z=2):  K(2)                원자가 전자: 2 (안정)
  Li (Z=3):  K(2) L(1)           원자가 전자: 1
  Be (Z=4):  K(2) L(2)           원자가 전자: 2
  B  (Z=5):  K(2) L(3)           원자가 전자: 3
  C  (Z=6):  K(2) L(4)           원자가 전자: 4
  N  (Z=7):  K(2) L(5)           원자가 전자: 5
  O  (Z=8):  K(2) L(6)           원자가 전자: 6
  F  (Z=9):  K(2) L(7)           원자가 전자: 7
  Ne (Z=10): K(2) L(8)           원자가 전자: 8 (안정)
  Na (Z=11): K(2) L(8) M(1)      원자가 전자: 1
  Mg (Z=12): K(2) L(8) M(2)      원자가 전자: 2
  Al (Z=13): K(2) L(8) M(3)      원자가 전자: 3
  Si (Z=14): K(2) L(8) M(4)      원자가 전자: 4
  P  (Z=15): K(2) L(8) M(5)      원자가 전자: 5
  S  (Z=16): K(2) L(8) M(6)      원자가 전자: 6
  Cl (Z=17): K(2) L(8) M(7)      원자가 전자: 7
  Ar (Z=18): K(2) L(8) M(8)      원자가 전자: 8 (안정)
