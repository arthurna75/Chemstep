...
BEGIN
  ...
  VALUES (
    ...
    '주기율표의 발전',
    E'■ 주기율표란 무엇인가?\n'
    '**주기율표**는 원소들을 원자 번호(또는 성질)에 따라 배열한 표로, 원소의 성질이 주기적으로 반복됨을 나타낸다.\n\n'
    '■ 돌베라이너의 세쌍원소설 (1829)\n'
  ...
  VALUES (
    ...
    '- 현재까지 7개 주기가 있으며, 주기가 커질수록 껍질 수와 원소 개수가 늘어난다 (자세한 내용은 아래 표 참고).\n'
    '→ 총 118종 원소가 7개 주기에 배치됨\n\n'
    '■ 족(Group): 세로줄\n'
    ...
    '■ 원자가 전자와 족\n'
    '대표 원소의 경우 족 번호의 일의 자리 = 원자가 전자 수이다 (단, 18족은 He만 예외적으로 2개, 나머지는 8개).\n'
    '예: Na(2,8,1)는 1족, Mg(2,8,2)는 2족, Cl(2,8,7)은 17족이다.',
    '[
  ...
  VALUES (
    ...
    '금속, 비금속, 준금속',
    E'■ 금속 원소 (Metals)\n'
    '**금속**은 주기율표의 왼쪽과 아래쪽에 위치하며, 전체 원소의 약 80%를 차지한다.\n\n'
    '주요 성질:\n'
    '- 상온에서 고체 (예외: Hg은 액체)\n'
    '- 금속 광택을 가짐\n'
    '- 전기 및 열 전도성이 우수\n'
    ...
    '**할로겐**은 원자가 전자 7개로 반응성이 매우 강하다.\n'
    '- 주로 이원자 분자(F₂, Cl₂, Br₂, I₂)로 존재\n'
    '- 금속과 반응하여 염(salt) 형성: 2Na + Cl₂ → 2NaCl\n'
    '- 족에서 아래로 갈수록 반응성 감소: F > Cl > Br > I\n\n'
    '■ 비활성 기체 (18족, He·Ne·Ar·Kr·Xe·Rn)\n'
    '**비활성 기체**는 원자가 전자 8개(He은 2개)로 최외각 전자가 완전히 충족되어 있다.\n'
    '- 화학 반응 거의 하지 않음 (안정)\n'
    '- 단원자 분자로 존재\n'
    '- 실생활 용도는 아래 표 참고\n\n'
    '■ 준금속 원소 (Metalloids)\n'
    '**준금속**은 금속과 비금속의 경계에 위치하며, 두 성질을 모두 가진다.\n'
  ...
  VALUES (
    ...
    '원자 반지름의 주기적 변화',
    E'■ 원자 반지름이란?\n'
    '**원자 반지름**은 원자핵 중심에서 최외각 전자까지의 평균 거리이다.\n'
    ...
    '■ 이온 반지름과의 차이\n'
    '**이온 반지름**은 전자 수 변화에 따라 원자 반지름과 달라진다 (자세한 수치는 아래 표 참고).\n'
  ...
  VALUES (
    ...
    '**이온화 에너지**는 기체 상태의 원자에서 전자 1개를 떼어내는 데 필요한 최소 에너지이다.\n'
    'X(g) + 에너지 → X⁺(g) + e⁻\n\n'
    '- 단위: kJ/mol 또는 eV\n'
    ...
    '■ 순차 이온화 에너지\n'
    '**순차 이온화 에너지**는 전자를 하나씩 차례로 제거할 때 필요한 에너지이다.\n'
    '- IE₁ < IE₂ < IE₃ < ···  (전자 제거될수록 전자 수 감소 → 남은 전자에 유효 핵전하 증가)\n'
    '- 큰 도약이 나타나는 구간 → 새로운 전자 껍질로 진입 (Na 예시는 아래 표 참고)\n\n'
    '■ 전기 음성도 (Electronegativity, EN)\n'
    '**전기 음성도**는 결합된 원자가 공유 전자쌍을 끌어당기는 상대적 능력이다.\n'
    '- **폴링 척도**: F = 4.0을 기준으로 상대적 값 설정\n'
    '- 단위 없음 (상대적 척도)\n\n'
    '■ 전기 음성도의 주기적 경향\n\n'
    '같은 주기: 오른쪽으로 갈수록 증가\n'
    ...
    '※ F(4.0)이 전기 음성도가 가장 높고, Cs·Fr(약 0.7)이 가장 낮음',
    '[
