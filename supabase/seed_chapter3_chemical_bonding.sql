...
BEGIN
  ...
  VALUES (
    ...
    '- H, Li, Be 등 예외: 가장 가까운 비활성 기체인 He처럼 전자 2개를 채우려 함(듀엣 규칙)\n'
    '- B, Al: 6개 전자로 안정(확장 옥텟 아님, 불완전 옥텟)\n'
    '- P, S, Cl, Xe 등 3주기 이상: 8개를 초과하는 확장 옥텟 가능\n\n'
    '■ 루이스 전자점식 (Lewis Dot Structure)\n'
    '원자의 원자가 전자를 점으로 나타내는 표기법\n'
    '- 원소 기호 주위에 원자가 전자를 1개씩 배치한 후 쌍을 이룸\n'
    '- 공유 결합에서 공유 전자쌍과 비공유 전자쌍을 구분하는 데 사용\n\n'
    '■ 화학 결합의 종류\n'
    '원자들이 옥텟 규칙을 만족하는 방법에 따라 결합 종류가 달라진다.\n\n'
    '① 이온 결합: 금속 + 비금속\n'
    '   → 금속이 전자를 비금속에게 줌 (전자 이동)\n'
    '   → 양이온 + 음이온 사이의 정전기적 인력\n\n'
    '② 공유 결합: 비금속 + 비금속\n'
    '   → 두 원자가 전자쌍을 공유\n'
    '   → 분자 형성\n\n'
    '③ 금속 결합: 금속 + 금속\n'
    '   → 금속 양이온과 자유 전자 사이의 인력\n'
    '   → 금속의 특성(전도성, 연성, 전성) 설명\n\n'
    '■ 전자 이동 vs 전자 공유\n'
  ...
  VALUES (
    ...
    '② 고체 상태: 이온이 고정 → 전기 전도성 없음\n'
    '③ 액체(용융) 또는 수용액 상태: 이온이 이동 가능 → 전기 전도성 있음\n'
    '④ 수용성: 극성 용매인 물에 잘 녹음\n'
  ...
  VALUES (
    ...
    '■ 단일 결합, 2중 결합, 3중 결합\n'
    '공유하는 전자쌍의 수에 따라 구분:\n'
    '- 단일 결합(single bond): 전자쌍 1쌍 공유\n'
    '  예: H₂ (H-H), HCl (H-Cl), H₂O (O-H)\n'
    '- 2중 결합(double bond): 전자쌍 2쌍 공유\n'
    '  예: O₂ (O=O), CO₂ (O=C=O), C₂H₄ (C=C)\n'
    '- 3중 결합(triple bond): 전자쌍 3쌍 공유\n'
    '  예: N₂ (N≡N), C₂H₂ (C≡C)\n\n'
    '■ 결합 차수와 결합의 성질\n'
    ...
    '예시 비교 (N-N 계열):\n'
    'N-N 단일결합: 결합 길이 145 pm, 결합 에너지 160 kJ/mol\n'
    'N=N 2중결합: 결합 길이 123 pm, 결합 에너지 418 kJ/mol\n'
    'N≡N 3중결합: 결합 길이 110 pm, 결합 에너지 945 kJ/mol\n\n'
    '■ 주요 분자의 루이스 구조\n'
    '① H₂O: O 원자가 H 2개와 각각 단일 결합, O에 비공유 전자쌍 2쌍\n'
    '② NH₃: N 원자가 H 3개와 각각 단일 결합, N에 비공유 전자쌍 1쌍\n'
    '③ CO₂: C 원자가 O 2개와 각각 2중 결합(O=C=O)\n'
    '④ N₂: N 원자 2개가 3중 결합(N≡N), 각 N에 비공유 전자쌍 1쌍\n'
    '⑤ CH₄: C 원자가 H 4개와 각각 단일 결합, 비공유 전자쌍 없음\n\n'
    '■ 공유 결합 화합물(분자)의 성질\n'
  ...
  VALUES (
    ...
    '극성 분자 (합벡터 ≠ 0):\n'
    '- HCl, HF, HBr: 2원자 이종핵 분자\n'
    '- H₂O: V자형 구조, O-H 결합의 쌍극자가 상쇄되지 않음\n'
    '- NH₃: 삼각뿔형 구조, N-H 결합의 쌍극자 합이 0이 아님\n\n'
    '무극성 분자 (합벡터 = 0):\n'
    '- H₂, N₂, O₂, Cl₂: 동핵 2원자 분자\n'
    '- CO₂: 직선형 구조, O=C=O에서 두 쌍극자가 서로 상쇄\n'
    '- CH₄: 정사면체형 구조, 대칭적 배열로 쌍극자 상쇄\n'
    '- BF₃: 평면 삼각형 구조, 대칭적 배열\n\n'
    '■ 분자의 극성과 성질\n'
  ...
  VALUES (
    ...
    '■ 금속 결합의 세기\n'
    '- 원자가 전자 수가 많을수록 자유 전자 밀도 증가 → 결합 강함\n'
    '  예: Na(1족, 1개) < Mg(2족, 2개) < Al(13족, 3개)\n'
    '  → 녹는점: Na(98°C) < Mg(650°C) < Al(660°C) ≈ W(텅스텐, 3422°C)\n'
    '- 원자 반지름이 작을수록 양이온과 전자 사이 거리 감소 → 결합 강함\n\n'
    '■ 고체 결정의 종류 비교\n'
    '① 이온 결정: 이온 결합 (NaCl, CaO)\n'
    '   - 녹는점 높음, 고체 전도성 없음, 액체/수용액 전도성 있음, 취성\n'
    '② 공유 결정(원자 결정): 공유 결합 (다이아몬드, SiO₂)\n'
    '   - 녹는점 매우 높음, 전도성 없음(흑연 예외), 매우 단단\n'
    '③ 분자 결정: 분자 간 인력 (H₂O, CO₂, I₂)\n'
    '   - 녹는점 낮음, 전도성 없음, 무름\n'
    '④ 금속 결정: 금속 결합 (Fe, Cu, Al)\n'
    '   - 녹는점 다양, 전도성 우수, 연성·전성',
    '[
