...
BEGIN
  ...
  VALUES (
    ...
    '① 홑원소 물질의 산화수 = 0  (예: Fe, O₂, H₂ 각 원소의 산화수는 0)\n'
    '② 단원자 이온의 산화수 = 이온의 전하  (예: Na⁺ → +1, Cl⁻ → -1)\n'
    '③ 화합물에서 O의 산화수 = -2  (예외: 과산화물 H₂O₂에서 O = -1)\n'
    '④ 화합물에서 H의 산화수 = +1  (예외: 금속 수소화물 NaH에서 H = -1)\n'
    '⑤ 다원자 이온의 산화수 합 = 이온 전하  (예: SO₄²⁻: S + 4(-2) = -2 → S = +6)\n'
    '⑥ 전기적으로 중성인 화합물의 산화수 합 = 0\n\n'
    '■ 산화제와 환원제\n'
  ...
  VALUES (
    ...
    '전지 전압: E°cell ≈ +1.10 V\n\n'
    '■ 표준 환원 전위 (E°)\n'
    '각 반쪽 반응이 환원될 때 발생하는 전압. 단위: V (볼트)\n'
    '- E°(Cu²⁺/Cu) = +0.34 V (환원되기 쉬움 → 양극)\n'
    '- E°(Zn²⁺/Zn) = -0.76 V (산화되기 쉬움 → 음극)\n'
  ...
  VALUES (
    ...
    '방전 시:\n'
    '음극(Pb): Pb + SO₄²⁻ → PbSO₄ + 2e⁻  (산화)\n'
    '양극(PbO₂): PbO₂ + 4H⁺ + SO₄²⁻ + 2e⁻ → PbSO₄ + 2H₂O  (환원)\n'
    '충전 시: 방전과 역반응. 외부 전원이 전자를 강제로 역방향으로 흘림.\n'
    '납축전지 전압: 약 2 V/셀 → 6셀 직렬 = 12 V 배터리\n\n'
    '■ 리튬이온 전지 (Li-ion Battery)\n'
    '스마트폰·전기차의 핵심 배터리. 에너지 밀도가 높고 가볍다.\n'
    '전해질: 유기 용매 속 Li⁺ 이온 (리튬염)\n'
    '방전 시:\n'
    '음극(흑연, C): LiC₆ → Li⁺ + e⁻ + C₆  (Li⁺가 탈리, 산화)\n'
    '양극(LiCoO₂): Li₁₋ₓCoO₂ + xLi⁺ + xe⁻ → LiCoO₂  (Li⁺가 삽입, 환원)\n'
  ...
  VALUES (
    ...
    '■ 연료전지의 종류와 비교\n'
    '- PEMFC (고분자막): 80°C 저온 운전, 자동차·드론 적합\n'
    '- SOFC (고체산화물): 700~1000°C 고온, 발전소·산업용\n'
    '- MCFC (용융탄산염): 650°C, 대형 발전 적합\n'
    '- AFC (알칼리): KOH 전해질, 우주선용\n\n'
    '■ 수소 경제와 에너지 전환\n'
  ...
  VALUES (
    ...
    '■ 산업 응용\n'
    '① 알루미늄 제련 (Hall-Héroult Process)\n'
    '   Al₂O₃(용융) 전기분해 → 순도 높은 Al 생산\n'
    '   음극: Al³⁺ + 3e⁻ → Al  양극: 2O²⁻ → O₂ + 4e⁻\n'
    '② 전기도금 (Electroplating)\n'
    '   도금할 물체를 음극, 도금 금속을 양극으로 연결\n'
    '   예: 니켈 도금 → Ni²⁺ + 2e⁻ → Ni (음극 표면에 석출)\n'
    '③ 구리 정련\n'
    '   조동(불순물 포함 Cu)을 양극, 순수 Cu를 음극으로 연결하여 99.99% 순동 제조\n'
    '④ 그린 수소 생산\n'
    '   재생에너지로 물을 전기분해 → H₂ 생산 (연료전지 연료)',
    '[
